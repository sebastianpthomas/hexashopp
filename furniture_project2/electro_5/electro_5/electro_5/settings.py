"""
Django settings for electro_5 project.
...
SECRET_KEY = 'django-insecure-2+i^zko4s&jb$35yhv@gnnec4hzh6eccpi9$wa5b0_#hg+0_sp'
...
WSGI_APPLICATION = 'electro_5.wsgi.application'
