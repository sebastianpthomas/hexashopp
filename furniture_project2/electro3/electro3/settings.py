"""
Django settings for electro3 project.
...
SECRET_KEY = 'django-insecure-=02l8wwt=30a2dou&^fx7m(%%_tsxh!_-a1i%**v=-tw)(29o6'
...
WSGI_APPLICATION = 'electro3.wsgi.application'
